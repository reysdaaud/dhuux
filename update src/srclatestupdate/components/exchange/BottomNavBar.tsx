// src/components/exchange/BottomNavBar.tsx
'use client';
import type { FC } from 'react';
import { Home, Search, MusicIcon as LucideSounds, FileText } from 'lucide-react'; // Changed LibraryIcon to MusicIcon for "Sounds"
...
const BottomNavBar: FC<BottomNavBarProps> = ({ activeTab, onTabChange }) => {
  const navItems: NavItem[] = [
    ...
    { label: 'Sounds', icon: LucideSounds, targetTab: 'Sounds' }, // Changed label and targetTab from 'Library'
